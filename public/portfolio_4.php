    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p>Projects I have been working on not yet finished, or not
                created by me</p>
                <h3>Project Details</h3>
                <ul>
                    <li>Finds Pictures</li>
                    <li>Maps</li>
...
<div class="col-lg-12">
            ...
            <div class="col-sm-3 col-xs-6">
                <a href="/portfolio_3.php">
                    <img class="img-responsive portfolio-item" src="/img/raspberrypi.jpeg" alt="amazon picture">
                </a>
            </div>
